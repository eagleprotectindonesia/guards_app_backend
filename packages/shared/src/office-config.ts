...
export const ATTENDANCE_REQUIRE_PHOTO_SETTING = 'ATTENDANCE_REQUIRE_PHOTO';
export const ENABLE_OFFICE_ATTENDANCE_LEAVE_EFFECTS_SETTING = 'ENABLE_OFFICE_ATTENDANCE_LEAVE_EFFECTS';
export const HIDE_ESCORT_SITES = 'HIDE_ESCORT_SITES';
export const ENABLE_OFFICE_ATTENDANCE_LEAVE_EFFECTS = 'ENABLE_OFFICE_ATTENDANCE_LEAVE_EFFECTS';
export const OFFICE_ATTENDANCE_CLOCK_OUT_GRACE_HOURS = 4;
export const ESCORT_GROUP_CHAT_AUTO_INCLUDE_CHAT_ADMINS = 'ESCORT_GROUP_CHAT_AUTO_INCLUDE_CHAT_ADMINS';
