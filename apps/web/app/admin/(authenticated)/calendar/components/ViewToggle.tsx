...
export function ViewToggle({ view, onViewChange, currentDate, onDateChange }: ViewToggleProps) {
  ...
  const title = format(currentDate, view === 'day' ? 'EEEE, MMMM d, yyyy' : view === 'week' ? "'Week of' MMM d, yyyy" : 'MMMM yyyy');
