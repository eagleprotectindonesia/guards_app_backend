...
export default async function OfficeShiftAuditPage(props: PageProps) {
  await requirePermission([PERMISSIONS.OFFICE_SHIFTS.VIEW, PERMISSIONS.CHANGELOGS.VIEW]);
