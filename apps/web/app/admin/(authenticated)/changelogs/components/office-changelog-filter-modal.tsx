...
export default function OfficeChangelogFilterModal({ 
  isOpen, 
  onClose, 
  onApply, 
  initialFilters,
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Filter Office Audit Logs">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              value={officeOptions.find(opt => opt.value === entityId)}
