...
export default function AttendanceRecord({ shift, onAttendanceRecorded }: AttendanceRecordProps) {
  ...
  const { captureAndUpload, isProcessing, statusMessage: photoStatus, cameraModal } = useAttendancePhotoUpload({ folder: 'attendance' });
    ...
    <>
      ...
      >
        ...
        <Button
          ...
          isDisabled={attendanceMutation.isPending || isProcessing}
